  ...
  head: () => ({
    meta: [
      { title: "Free AI Chat – Nalora" },
      {
        name: "description",
        content:
          "Talk to Nalora's AI-powered emotional support companion, available 24/7 for postpartum care and support.",
      },
    ],
  }),
    ...
    <ProtectedPage allowedRole="patient">
      ...
      >
        ...
        >
          ...
          >
            ...
            <div style={{ flex: 1 }}>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "5px", marginTop: "2px" }}>
                ...
                />
                <span style={{ fontSize: "0.75rem", color: "oklch(0.55 0.01 60)" }}>
                  Online · n8n-powered emotional support
                </span>
              </div>
            </div>
            <div
          ...
          >
            🔒 This chat is confidential and powered by n8n AI. For emergencies, call 112 or iCall:
            9152987821.
          </div>
          ...
          >
            ...
            <button
              ...
              style={{
                ...
                transition: "all 0.2s",
                boxShadow:
                  input.trim() && !isTyping ? "0 4px 14px oklch(0.74 0.11 18 / 0.28)" : "none",
              }}
            >
              <svg
                width="19"
