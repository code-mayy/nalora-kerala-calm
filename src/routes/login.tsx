  ...
  head: () => ({
    meta: [
      { title: "Login – Nalora" },
      {
        name: "description",
        content:
          "Sign in to your Nalora account to access your care dashboard, AI chat, and appointments.",
      },
    ],
  }),
  component: LoginPage,
...
function LoginPage() {
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    if (!credential.trim()) {
      setError(
        isDoctor
          ? "Please enter your doctor email address."
          : mode === "email"
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          borderRadius: "50%",
          background: isDoctor
            ? "radial-gradient(circle, oklch(0.6 0.05 240 / 0.08), transparent 65%)"
            : "radial-gradient(circle, oklch(0.74 0.11 18 / 0.1), transparent 65%)",
          pointerEvents: "none",
          transition: "background 0.5s ease",
        }}
      />
      <div
        ...
        style={{
          ...
          borderRadius: "50%",
          background: isDoctor
            ? "radial-gradient(circle, oklch(0.5 0.04 200 / 0.08), transparent 65%)"
            : "radial-gradient(circle, oklch(0.78 0.13 55 / 0.1), transparent 65%)",
          pointerEvents: "none",
          transition: "background 0.5s ease",
        }}
      />
            ...
            >
              ...
              <div>
                ...
                <input
                  ...
                  placeholder={
                    isDoctor ? "doctor@nalora.com" : isEmail ? "you@example.com" : "+91 98765 43210"
                  }
                  ...
                  onFocus={(e) => {
                    e.target.style.borderColor = isDoctor ? "oklch(0.5 0.04 200)" : "var(--rose)";
                    e.target.style.boxShadow = isDoctor
                      ? "0 0 0 3px oklch(0.5 0.04 200 / 0.1)"
                      : "0 0 0 3px oklch(0.74 0.11 18 / 0.1)";
                  }}
                  onBlur={(e) => {
                    e.target.style.borderColor = error ? "var(--rose)" : "oklch(0.88 0.02 55)";
              ...
              <div>
                ...
                >
                  ...
                  <a
                    ...
                    style={{
                      fontSize: "0.76rem",
                      color: isDoctor ? "oklch(0.5 0.04 200)" : "var(--rose)",
                      fontWeight: 500,
                      textDecoration: "none",
                    }}
                  >
              ...
              {error && (
                <div
                  style={{
                    ...
                    padding: "11px 14px",
                    borderRadius: "11px",
                    background: "oklch(0.98 0.02 18)",
                    border: "1px solid oklch(0.74 0.11 18 / 0.2)",
              ...
              <button
                ...
                style={{
                  ...
                  boxShadow: loading
                    ? "none"
                    : isDoctor
                      ? "0 8px 28px oklch(0.5 0.04 240 / 0.25)"
                      : "0 8px 28px oklch(0.74 0.11 18 / 0.32)",
                  transition: "all 0.2s",
                  display: "flex",
                  alignItems: "center",
                  justifyContent: "center",
            ...
            {isDoctor ? (
              <div style={{ textAlign: "center", marginTop: "24px" }}>
                ...
                <button
                  ...
                  onMouseEnter={(e) => {
                    (e.currentTarget as HTMLElement).style.borderColor = "oklch(0.5 0.04 200)";
                    (e.currentTarget as HTMLElement).style.color = "oklch(0.5 0.04 200)";
                  }}
                  onMouseLeave={(e) => {
              ...
              <>
                ...
                >
                  ...
                  <span
                    style={{ fontSize: "0.75rem", color: "oklch(0.7 0.01 60)", fontWeight: 500 }}
                  >
                    or
                  </span>
                  <div style={{ flex: 1, height: "1px", background: "oklch(0.9 0.01 60)" }} />
                ...
                <div style={{ textAlign: "center" }}>
                  ...
                  >
                    ...
                    <span style={{ fontSize: "0.7rem", color: "oklch(0.7 0.01 60)" }}>
                      practitioners
                    </span>
                    <div style={{ flex: 1, height: "1px", background: "oklch(0.92 0.01 60)" }} />
                  </div>
